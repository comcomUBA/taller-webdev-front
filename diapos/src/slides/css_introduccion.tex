...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \item \inlinecode{text-align} para alinear el texto. Recibe como 
              valor alguna keyword indicando el modo.
    \end{itemize}
...
\begin{frame}[fragile]
    ...
    sobre la historia de nuestro departamento. Pueden usar las propiedades que vimos 
